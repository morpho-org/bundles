...
Bundles are not meant to hold token balances. Any tokens sent to a bundle, directly or as leftover residue, should be considered permissionlessly skimmable.
