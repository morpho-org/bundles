...
// Pinned copy of vault-v2's src/periphery/BlueAdapterV2PublicAllocator.sol, from the open PR
// https://github.com/morpho-org/vault-v2/pull/937 (branch public-allocator). Only the import paths differ.
// Delete this vendored copy and deploy from lib/vault-v2 once the PR is released.
