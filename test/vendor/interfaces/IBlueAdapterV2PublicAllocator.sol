...
// Pinned copy of vault-v2's src/periphery/interfaces/IBlueAdapterV2PublicAllocator.sol, from the open PR
// https://github.com/morpho-org/vault-v2/pull/937 (branch public-allocator). Only the import path differs.
