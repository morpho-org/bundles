...
contract MidnightBundlesMakerTest is Test {
    ...
    function setUp() public {
        ...
        offerLog = new Log();
        midnightBundles = new MidnightBundlesV1(
    ...
    function testMakeRejectsUnexpectedRatifierResponse(bool useSignature) public {
        ...
        vm.expectRevert(IMidnightBundlesV1.InvalidRatifierResponse.selector);
    ...
    function testMakeRevertsWhenConsumptionExceedsLimit(uint128 maxConsumed, uint128 consumed) public {
        ...
        vm.expectRevert(IMidnightBundlesV1.ConsumedAboveMax.selector);
        midnightBundles.midnightBundlesV2CancelAndMake(
            blueMarket,
            PARKED_ASSETS,
            CALLBACK_SALT,
    ...
    function testCancelSkipsPublicationWithoutAuthorizingRatifiers(address ignoredRatifier) public {
        MidnightBundlesV1 cancellingBundles = new MidnightBundlesV1(
    ...
    function testMakeIsAtomicWhenLogReverts(bool useRateRatifier, bool useSignature) public {
        ...
        MidnightBundlesV1 revertingBundles = new MidnightBundlesV1(
    ...
    function testConstructorRevertsWhenFactoryMidnightIsInconsistent() public {
        ...
        vm.expectRevert(IMidnightBundlesV1.InconsistentMidnight.selector);
        new MidnightBundlesV1(address(midnight), address(morpho), address(inconsistentFactory), address(offerLog));
    }
    ...
    function testConstructorRevertsWhenFactoryBlueIsInconsistent() public {
        ...
        vm.expectRevert(IMidnightBundlesV1.InconsistentBlue.selector);
        new MidnightBundlesV1(address(midnight), address(morpho), address(inconsistentFactory), address(offerLog));
    }
    ...
    function testMakeRevertsWhenParkingAndSupplyingCollateral() public {
        ...
        vm.prank(lender);
        vm.expectRevert(IMidnightBundlesV1.InconsistentInputs.selector);
        midnightBundles.midnightBundlesV2CancelAndMake(
            blueMarket,
            PARKED_ASSETS,
            CALLBACK_SALT,
    ...
    function testMakeRevertsWhenNativeIsNotConsumed() public {
        ...
        vm.prank(lender);
        vm.expectRevert(IMidnightBundlesV1.UnusedNative.selector);
