...
/// @dev When using a Vault V2 with this contract, the sendAssetsGate must allow this contract to deposit assets. The gate can query the bundle's initiator through to the exposed transient variable.
