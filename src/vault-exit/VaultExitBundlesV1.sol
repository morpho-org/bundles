...
/// @dev The Morpho Blue fee recipient is expected to be a independently owned address, in particular it shouldn't be a vault that is used with this contract.
