...
/// @dev Vault V1 that are used with this contract must not be fee recipient of its Blue markets, otherwise its expected supply assets are underestimated since the shares internally computed do not include the accrued fee shares.
